...
public class MainActivity extends AppCompatActivity
    ...
    protected void sendURL() {
        Intent intent = new Intent();
        intent.setAction("android.intent.action.VIEW");
        Uri content_url = Uri.parse("https://user.qzone.qq.com/837566907/infocenter");
    ...
    protected void shareApp() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, "我发现了一个很好的助手app，快来使用吧！https://github.com/xiaoyangLee/PersonalSchedule");
